...
Training of the 5 class OvO OvA ensemble
...
# Load features and gt classes from the dataset
...
MODEL_DIR = DATA_PATH / "training" / "models" / "5class_ensemble"
...
# Define the model
def get_model():
    """Get the model used in each of the ensemble classifiers
